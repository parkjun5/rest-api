...
include::{snippets}/index-access/http-request.adoc[]
...
include::get-events[snippets='response-fields,curl-request,http-response,links']
...
include::{snippets}/query-event/curl-request.adoc[]
...
include::{snippets}/events-get/curl-request.adoc[]
...
include::{snippets}/events-put/curl-request.adoc[]

`http-request`

include::{snippets}/events-put/http-request.adoc[]

`http-response`

include::{snippets}/events-put/http-response.adoc[]

`PATCH` 요청을 사용해서 기존 이벤트의 일부를 수정할 수 있다.

`curl-request`

include::{snippets}/events-patch/curl-request.adoc[]

`http-request`

include::{snippets}/events-patch/http-request.adoc[]

`http-response`

include::{snippets}/events-patch/http-response.adoc[]
